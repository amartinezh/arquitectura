			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
							<!--  <form action="index.html" id="login-form" class="smart-form client-form"> -->
							<form:form method="POST" action="validar7" ModelAttribute="user" commandName="user" class="smart-form client-form">
								<header>
								<img width="100" height="60" src="<c:url value="/resources/img/adm/logo.png" />" >
									Ingreso al 7
								</header>
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
							<!--  <form action="index.html" id="login-form" class="smart-form client-form"> -->
							<form:form method="POST" action="validar12" ModelAttribute="user" commandName="user" class="smart-form client-form">
								<header>
								<img width="100" height="60" src="<c:url value="/resources/img/adm/logo.png" />" >
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
							<!--  <form action="index.html" id="login-form" class="smart-form client-form"> -->
							<form:form method="POST" action="validar8" ModelAttribute="user" commandName="user" class="smart-form client-form">
								<header>
								<img width="100" height="60" src="<c:url value="/resources/img/adm/logo.png" />" >
